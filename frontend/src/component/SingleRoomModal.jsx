                        ...
                        <div className='lg:w-2/3 md:1/2 w-full'>
                            ...
                            <div className='py-2 capitalize border-b-2'>
                                ...
                                <div className='flex text-xs  p-2'>
                                    <div className='capitalize text-senary  bg-senary/20 px-2 py-1 mx-1 rounded'>adults : {room?.roomType?.capacity?.adults}</div>
                                    <div className='capitalize text-senary bg-senary/20 px-2 py-1 mx-1 rounded'>children : {room?.roomType?.capacity?.children}</div>
                                </div>
                            </div>
                            <div className='py-2 capitalize border-b-2'>
                                <h2 className='text-lg font-semibold capitalize text-senary'>price</h2>
                                <div className='flex text-xs  p-2'>
                                    <div className='capitalize text-senary bg-senary/20 px-2 py-1 mx-1 rounded'>base :  ${room?.roomType?.price}</div>
                                </div>
                            </div>
                            <div className='py-2 capitalize border-b-2'>
                                <h2 className='text-lg font-semibold capitalize text-senary'>Bed</h2>
                                <div className='flex text-xs  p-2'>
                                    <div className='capitalize text-senary bg-senary/20 px-2 py-1 mx-1 rounded'>child: {room?.roomType?.bed?.childBed?.count} {room?.roomType?.bed?.childBed?.type}</div>
                                    <div className='capitalize text-senary bg-senary/20 px-2 py-1 mx-1 rounded'>main :  {room?.roomType?.bed?.mainBed?.count} {room?.roomType?.bed?.mainBed?.type}</div>
                                </div>
                            </div>
                            {/* Amenities */}
                            {room?.roomType?.features?.length > 0 && (
                                <div className='py-2 capitalize border-b-2'>
                                    ...
                                    <div className="flex flex-wrap items-center gap-1.5  p-2 text-xs">
                                        {room?.roomType?.features?.map((feature, idx) => {
                                            const label =
