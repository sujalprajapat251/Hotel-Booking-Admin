                                                ...
                                                <div className="flex items-center gap-3 flex-1 min-w-0">
                                                    ...
                                                    <div className="min-w-0">
                                                        ...
                                                        <p className={`text-xs ${isOrderPreparedByAnotherChef(item) ? "text-gray-400" : "text-gray-500"}`}>
                                                            Qty: {item?.qty} • From: {item?.from} - {item?.from === "room" ? item?.room?.roomNumber : item?.table?.title}
                                                        </p>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex justify-between items-center pb-1 border-b border-gray-100">
                                                {selected?.from === "room" ?
                                                    <>
                                                        <span className="text-gray-600 text-[14px]">Room</span>
                                                        <span className={`font-semibold capitalize text-[15px] ${isOrderPreparedByAnotherChef(selected) ? "text-gray-500" : "text-gray-800"}`}>{selected?.room?.roomNumber}</span>
                                                    </>
                                                    :
                                                    <>
